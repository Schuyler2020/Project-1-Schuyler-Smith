...
public class BookStore extends JFrame {
    ...
    public BookStore() throws FileNotFoundException
    {
        ...
        //update button text
        //this.jbtProcessItem.setText("Process Item #" + totalItems);
        //this.jbtConfirmItem.setText("Confirm Item #" + totalItems);
        ...
        jbtProcessItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(bookIndex != -1)
                {
                    ...
                    order.setItemInfo(foundBook.getBookID() + "", foundBook.getTitle(), foundBook.getPrice() + "", quantityOfItem + "", order.discount(quantityOfItem) + "", order.getTotalDiscount(quantityOfItem, foundBook.getPrice()) + "");
                    String bookInfo = foundBook.getBookID() + foundBook.getTitle() +  " $" + foundBook.getPrice() + " " + quantityOfItem + " " + order.discount(quantityOfItem) + "% " + order.getTotalDiscount(quantityOfItem, foundBook.getPrice()); //need to get discound
        ...
        jbtConfirmItem.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                order.addtoOrder(jtfItemInfo.getText());
    ...
    public void getInventoryFromFile() throws FileNotFoundException {
        ...
        File file = new File("../Project 1 Schuyler Smith/src/inventory.txt");
